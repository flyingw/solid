...
static const std::string rocksdb_build_git_sha  = "d41fe906167a7d100777a8820ce4d6308ae42a9d";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:v11.2.5";
#define HAS_GIT_CHANGES 0
#if HAS_GIT_CHANGES == 0
// If HAS_GIT_CHANGES is 0, the GIT date is used.
// Use the time the branch/tag was last modified
static const std::string rocksdb_build_date = "rocksdb_build_date:2026-09-09 17:30:21";
#else
