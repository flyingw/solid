...
static const std::string rocksdb_build_git_sha  = "9b16e8841fb96eccedb98fe42a27fecb1effffb3";
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:10.2.1";
